...
--	RETURNS float8
--	AS '/Library/PostgreSQL/9.2/lib/postgis-2.0', 'geometry_gist_selectivity_nd'
--	LANGUAGE 'c';

-- Availability: 2.0.0
--CREATE OR REPLACE FUNCTION geography_gist_join_selectivity_nd(internal, oid, internal, smallint)
--	RETURNS float8
--	AS '/Library/PostgreSQL/9.2/lib/postgis-2.0', 'geometry_gist_join_selectivity_nd'
--	LANGUAGE 'c';
...
CREATE OR REPLACE FUNCTION ST_estimated_extent(text,text,text) RETURNS box2d AS
	'/Library/PostgreSQL/9.2/lib/postgis-2.0', 'geometry_estimated_extent'
...
CREATE OR REPLACE FUNCTION postgis_version() RETURNS text
	AS '/Library/PostgreSQL/9.2/lib/postgis-2.0'
	LANGUAGE 'c' IMMUTABLE;
...
CREATE OR REPLACE FUNCTION CheckAuthTrigger()
	RETURNS trigger AS 
	'/Library/PostgreSQL/9.2/lib/postgis-2.0', 'check_authorization'
	LANGUAGE C;

CREATE OR REPLACE FUNCTION GetTransactionID()
	RETURNS xid AS 
	'/Library/PostgreSQL/9.2/lib/postgis-2.0', 'getTransactionID'
	LANGUAGE C;
