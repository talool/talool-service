...
- (id) initWithCoder: (NSCoder *) decoder
{
  ...
  {
    __errorDesc = [[decoder decodeObjectForKey: @"errorDesc"] retain];
    __errorDesc_isset = YES;
  }
  return self;
}
...
- (NSString *) errorDesc {
  return [[__errorDesc retain] autorelease];
}
...
- (id) initWithAddressId: (int64_t) addressId address1: (NSString *) address1 address2: (NSString *) address2 city: (NSString *) city stateProvinceCounty: (NSString *) stateProvinceCounty zip: (NSString *) zip country: (NSString *) country created: (Timestamp) created updated: (Timestamp) updated
{
  ...
  __address1 = [address1 retain];
  __address1_isset = YES;
  __address2 = [address2 retain];
  __address2_isset = YES;
  __city = [city retain];
  __city_isset = YES;
  __stateProvinceCounty = [stateProvinceCounty retain];
...
- (id) initWithCoder: (NSCoder *) decoder
{
  ...
  {
    __address1 = [[decoder decodeObjectForKey: @"address1"] retain];
    __address1_isset = YES;
  }
  ...
  {
    __stateProvinceCounty = [[decoder decodeObjectForKey: @"stateProvinceCounty"] retain];
    __stateProvinceCounty_isset = YES;
  }
...
- (NSString *) address1 {
  return [[__address1 retain] autorelease];
}
...
- (NSString *) stateProvinceCounty {
  return [[__stateProvinceCounty retain] autorelease];
}

- (void) setStateProvinceCounty: (NSString *) stateProvinceCounty {
  [stateProvinceCounty retain];
  [__stateProvinceCounty release];
...
- (id) initWithCoder: (NSCoder *) decoder
{
  ...
  {
    __customer = [[decoder decodeObjectForKey: @"customer"] retain];
    __customer_isset = YES;
  }
  if ([decoder containsValueForKey: @"password"])
  {
...
- (Customer *) customer {
  return [[__customer retain] autorelease];
}
...
- (id) initWithCoder: (NSCoder *) decoder
{
  ...
  {
    __error = [[decoder decodeObjectForKey: @"error"] retain];
    __error_isset = YES;
  }
  return self;
}
...
- (ServiceException *) error {
  return [[__error retain] autorelease];
}
...
- (void) send_registerCustomer: (Customer *) customer : (NSString *) password
{
...
- (void) recv_registerCustomer
{
  ...
  RegisterCustomer_result * result = [[[RegisterCustomer_result alloc] init] autorelease];
...
- (void) registerCustomer: (Customer *) customer : (NSString *) password
{
  [self send_registerCustomer: customer : password];
...
- (void) process_registerCustomer_withSequenceID: (int32_t) seqID inProtocol: (id<TProtocol>) inProtocol outProtocol: (id<TProtocol>) outProtocol
{
  ...
  [mService registerCustomer: [args customer]: [args password]];
