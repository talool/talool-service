...
public interface DealOffer extends IdentifiableUUID, Serializable, TimeAware, PropertyEntity {
  ...
  /**
   * Returns true of the Deal offer is within the scheduled time (start/end date) false otherwise.
   * 
   * @return
   */
  ...
  /**
   * Checks whether the deal offer is free
   * 
   * @return true if deal offer is free, meaning DealType=='FREE_BOOK' or the price==0
   */
